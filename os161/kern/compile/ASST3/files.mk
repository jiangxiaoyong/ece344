...
sys__exit.o: ${S}/userprog/sys__exit.c
	${COMPILE.c} ${S}/userprog/sys__exit.c
SRCS+=${S}/userprog/sys__exit.c
OBJS+=sys__exit.o

sys_fork.o: ${S}/userprog/sys_fork.c
	${COMPILE.c} ${S}/userprog/sys_fork.c
SRCS+=${S}/userprog/sys_fork.c
OBJS+=sys_fork.o

sys_getpid.o: ${S}/userprog/sys_getpid.c
	${COMPILE.c} ${S}/userprog/sys_getpid.c
SRCS+=${S}/userprog/sys_getpid.c
OBJS+=sys_getpid.o

sys_waitpid.o: ${S}/userprog/sys_waitpid.c
	${COMPILE.c} ${S}/userprog/sys_waitpid.c
SRCS+=${S}/userprog/sys_waitpid.c
OBJS+=sys_waitpid.o
...
sys_execv.o: ${S}/userprog/sys_execv.c
	${COMPILE.c} ${S}/userprog/sys_execv.c
SRCS+=${S}/userprog/sys_execv.c
OBJS+=sys_execv.o

sys_sbrk.o: ${S}/userprog/sys_sbrk.c
	${COMPILE.c} ${S}/userprog/sys_sbrk.c
SRCS+=${S}/userprog/sys_sbrk.c
OBJS+=sys_sbrk.o
...
tlb.o: ${S}/vm/tlb.c
	${COMPILE.c} ${S}/vm/tlb.c
SRCS+=${S}/vm/tlb.c
OBJS+=tlb.o

segmentation.o: ${S}/vm/segmentation.c
	${COMPILE.c} ${S}/vm/segmentation.c
SRCS+=${S}/vm/segmentation.c
OBJS+=segmentation.o

bitmap_disk.o: ${S}/vm/bitmap_disk.c
	${COMPILE.c} ${S}/vm/bitmap_disk.c
SRCS+=${S}/vm/bitmap_disk.c
OBJS+=bitmap_disk.o

page_replacement.o: ${S}/vm/page_replacement.c
	${COMPILE.c} ${S}/vm/page_replacement.c
SRCS+=${S}/vm/page_replacement.c
OBJS+=page_replacement.o
