...
#define TRUE 1
#define FAULT 0
#define TLBLO_NO_WRITE 0x00000000
...
struct addrspace {
	...
	u_int32_t as_segmentSize1;
	u_int32_t as_segmentSize1_refine;
	u_int32_t as_segmentSize2;
	u_int32_t as_segmentSize2_refine;
...
int               as_define_region(struct addrspace *as, 
				   vaddr_t vaddr, size_t sz, u_int32_t offset,
...
int load_elf(struct vnode *v, vaddr_t *entrypoint, char * progname);
int
